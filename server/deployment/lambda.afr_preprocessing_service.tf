...
# resource "null_resource" "build_afr_preprocessing_service" {
#   triggers = {
...
# data "archive_file" "afr_preprocessing_service" {
#   type        = "zip"
#   output_path = "${path.module}/../code/afr_preprocessing_service.zip" # TODO: change here
#   source_dir  = "${path.module}/../code/afr_preprocessing_service"     # TODO: change here

#   depends_on = [
#     null_resource.build_afr_preprocessing_service # TODO: change here
#   ]
# }

# # Tells Terraform to create an AWS lambda function
# # - Filename here corresponds to the output_path in archive_file.afr_preprocessing_service.
...
# resource "aws_lambda_function" "afr_preprocessing_service" {
#   filename      = data.archive_file.afr_preprocessing_service.output_path
#   function_name = "${var.group_name}_${terraform.workspace}_afr_preprocessing_service" # TODO: change here
#   handler       = "handler.handler"
#   runtime       = "python3.9" # TODO: change here

#   role             = aws_iam_role.iam_for_lambda.arn
#   source_code_hash = data.archive_file.afr_preprocessing_service.output_base64sha256 # TODO: change here
...
#     "arn:aws:lambda:ap-southeast-2:336392948345:layer:AWSSDKPandas-Python39:18"
#   ]
# }
...
# resource "aws_lambda_permission" "afr_preprocessing_service" {
#   statement_id  = "AllowAPIGatewayInvoke"
#   action        = "lambda:InvokeFunction"
#   function_name = aws_lambda_function.afr_preprocessing_service.function_name # TODO: change here
#   principal     = "apigateway.amazonaws.com"

#   source_arn = "${data.aws_apigatewayv2_api.api_gateway_global.execution_arn}/*/*/collection/afr_preprocessing_service" # TODO: change here
# }
...
# resource "aws_apigatewayv2_integration" "afr_preprocessing_service" {
#   api_id           = var.gateway_api_id
#   integration_type = "AWS_PROXY"

#   integration_uri    = aws_lambda_function.afr_preprocessing_service.invoke_arn # TODO: change here
...
# resource "aws_apigatewayv2_route" "afr_preprocessing_service" {
#   api_id    = var.gateway_api_id
#   route_key = "GET /${var.group_name}/collection/afr_preprocessing_service" # TODO: change here

#   target = "integrations/${aws_apigatewayv2_integration.afr_preprocessing_service.id}" # TODO: change here
...
# resource "aws_cloudwatch_log_group" "afr_preprocessing_service_log" {
#   name              = "/aws/lambda/${aws_lambda_function.afr_preprocessing_service.function_name}" # TODO: change here
#   retention_in_days = 7
#   lifecycle {
